...
class RSDotsView: UILabel {
    ...
    func startAnimating() {
        ...
        for dot in self.subviews as! [RSDotView] {
            ...
            UIView.animate(withDuration: Double(0.5), delay:delay, options: UIView.AnimationOptions().union(UIView.AnimationOptions.repeat).union(UIView.AnimationOptions.autoreverse) , animations: { () -> Void in
