...
class MDRotatingPieChart: UIControl {
    ...
    override init(frame: CGRect) {
        ...
        labelCenter.font=UIFont.systemFont(ofSize: 11)
        
        labelCenter.textAlignment = NSTextAlignment.justified
    ...
    func build() {
        ...
        ratingRec.PercentageArray = NSMutableArray()
    ...
    func createLabel(_ angleSum:CGFloat, slice:Slice) -> UILabel {
        ...
        ratingRec.PercentageArray.add(label.text!)
