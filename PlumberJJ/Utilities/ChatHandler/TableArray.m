...
-(NSString *)convertFormatOfDate:(NSString *)date originalFormat:(NSString *)originalFormat destinationFormat: (NSString *)destinationFormat {
    
    // Orginal format :
    NSDateFormatter *dateOriginalFormat = [[NSDateFormatter alloc] init];
    dateOriginalFormat.dateFormat = originalFormat ;
    
    // Destination format :
    NSDateFormatter *dateDestinationFormat = [[NSDateFormatter alloc] init];
    dateDestinationFormat.dateFormat = destinationFormat;
    
    NSDate *dateFromString = [dateOriginalFormat dateFromString:date];
    
    NSString *dateFormated = [dateDestinationFormat stringFromDate:dateFromString];
...
-(NSDateFormatter *)formatter
{
    if (!_formatter)
    {
        ...
        _formatter.dateFormat = @"MM/dd/YY";
