...
static int FONT_SIZE = 14;NSString *DEFAULT_TITLE;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(X_BUFFER, 3, frame.size.width-2*X_BUFFER, 25)];
        [titleLabel setFont:[UIFont fontWithName:@"Roboto" size:FONT_SIZE]];
        ...
        messageLabel = [[UILabel alloc]initWithFrame:CGRectMake(X_BUFFER, STATUS_BAR_HEIGHT +Y_BUFFER*2.3, frame.size.width-2*X_BUFFER, 50)];
        messageLabel.textColor = defaultTextColor;
        messageLabel.font = [messageLabel.font fontWithSize:FONT_SIZE];
        messageLabel.lineBreakMode = NSLineBreakByWordWrapping;
        messageLabel.numberOfLines = 4; // 2 lines ; 0 - dynamic number of lines
