...
internal class WDResizableCropOverlayView: WDImageCropOverlayView {
        ...
        set {
            ...
            contentView?.frame = CGRect(x: (
                width - initialContentSize.width) / 2,
                                        y: (height - CGFloat(toolbarSize) - initialContentSize.height) / 2,
            ...
            cropBorderView?.frame = CGRect(
                ...
                y: (height - CGFloat(toolbarSize) - initialContentSize.height) / 2 - kBorderCorrectionValue,
    ...
    private func resizeWithTouchPoint(point: CGPoint) {
        ...
        var newFrame =  CGRect(x: (cropBorderView.frame.origin.x + xChange), y: (cropBorderView.frame.origin.y + yChange), width: cropBorderView.frame.size.width + widthChange, height: cropBorderView.frame.size.height + heightChange)
