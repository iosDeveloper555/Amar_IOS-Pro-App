...
//                        initialContentSize: CGRect(newValue.width, newValue.height))
                    self.cropOverlayView = WDResizableCropOverlayView(frame: self.bounds, initialContentSize: CGSize(width: newValue.width, height: newValue.height))
