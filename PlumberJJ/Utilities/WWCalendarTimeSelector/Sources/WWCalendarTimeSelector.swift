            ...
            for i in 1...7 {
                if date.weekday == i {
                    if date == flashDate {
                        ...
                        UIView.animate(withDuration: flashDuration/2, delay: 0.0, options: [.allowAnimatedContent,.allowUserInteraction,.beginFromCurrentState,.curveEaseOut])
                        {
                            flashView.alpha = 0.75
                        } completion: { (finished) in
                            
                            UIView.animate(withDuration: self.flashDuration / 2, delay: 0, options: [.allowAnimatedContent,.allowUserInteraction,.beginFromCurrentState,.curveEaseIn]) {
                                flashView.alpha = 0
...
//            var str = NSAttributedString(string: "AM", attributes: [NSFontAttributeName: fontAMPMHighlight, NSForegroundColorAttributeName: fontColorAMPMHighlight, NSParagraphStyleAttributeName: paragraph])
        ...
        if showingHour {
            let textAttr : [NSAttributedString.Key : Any] = [(NSAttributedString.Key.font as NSString) as NSAttributedString.Key : fontHour, (NSAttributedString.Key.foregroundColor as NSString) as NSAttributedString.Key: fontColorHour, (NSAttributedString.Key.paragraphStyle as NSString) as NSAttributedString.Key: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [(NSAttributedString.Key.font as NSString) as NSAttributedString.Key : fontHourHighlight, (NSAttributedString.Key.foregroundColor as NSString) as NSAttributedString.Key: fontColorHourHighlight, (NSAttributedString.Key.paragraphStyle  as NSString) as NSAttributedString.Key: paragraph]
            ...
            let textAttr : [NSAttributedString.Key : Any] = [(NSAttributedString.Key.font as NSString) as NSAttributedString.Key : fontMinute, (NSAttributedString.Key.foregroundColor as NSString) as NSAttributedString.Key: fontColorMinute, (NSAttributedString.Key.paragraphStyle as NSString) as NSAttributedString.Key: paragraph]
            let textAttrHighlight : [NSAttributedString.Key : Any] = [(NSAttributedString.Key.font as NSString) as NSAttributedString.Key: fontMinuteHighlight, (NSAttributedString.Key.foregroundColor as NSString) as NSAttributedString.Key: fontColorMinuteHighlight, (NSAttributedString.Key.paragraphStyle as NSString) as NSAttributedString.Key: paragraph]
