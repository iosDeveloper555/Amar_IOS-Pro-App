...
class SMSegment: UIView {
    ...
    private func resetContentFrame() {
        ...
        var imageViewFrame = CGRect(x: 0.0, y: verticalMargin, width: 0.0, height: frame.size.height - verticalMargin * 2)
...
label.frame = CGRect(x: imageViewFrame.origin.x + imageViewFrame.size.width + distanceBetween, y: verticalMargin, width: labelWidth, height: frame.size.height - verticalMargin * 2)
    }
    ...
    override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
        ...
        self.delegate?.selectSegment(segment: self)
    }
}
