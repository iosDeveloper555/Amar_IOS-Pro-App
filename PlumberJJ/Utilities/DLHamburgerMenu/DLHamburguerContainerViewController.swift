...
class DLHamburguerContainerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let pangestureRecognizer = UIPanGestureRecognizer.init(target: self, action:#selector(panGestRecognized(recognizer:)))
...
//        self.view.addGestureRecognizer(self.hamburguerViewController.gestureRecognizer!)
    ...
    // MARK: - Gestu@objc re recognizer
    // TAP: hide the menu
    @objc func tapGestureRecognized(recognizer: UITapGestureRecognizer) {
        self.hide()
    }
    @objc func panGestRecognized(recognizer: UIPanGestureRecognizer) {
        // inform the delegate
