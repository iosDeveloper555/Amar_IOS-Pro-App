...
//    var gestureRecognizer: UIPanGestureRecognizer?
    ...
    override var childForStatusBarStyle: UINavigationController?
    {
        return self.contentViewController
    }
    
    override var childForStatusBarHidden: UINavigationController?
    {
        return self.contentViewController
    }
...
//        gestureRecognizer = UIPanGestureRecognizer(target: containerViewController!, action: #selector(self.panGestureRecognized(recognizer:)))
    ...
    // MARK@objc @objc : - Gesture recognizer
