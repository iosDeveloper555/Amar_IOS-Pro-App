...
class DLDemoRootViewController: DLHamburguerViewController {
    ...
    {
        self.contentViewController = self.storyboard?.instantiateViewController(withIdentifier: "\(notifi.object!)") as? UINavigationController
    ...
    override func awakeFromNib() {
        self.contentViewController = (self.storyboard?.instantiateViewController(withIdentifier: "StarterNavVCSID"))! as UIViewController as? UINavigationController
